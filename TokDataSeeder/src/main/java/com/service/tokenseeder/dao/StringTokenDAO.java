...
public class StringTokenDAO {
	 ...
	 */
	public String insertTokenToBank(Session session,long stringmaxvalue, String strtablename, String startvalue, String pattern,
			int configurationIdentifier) throws TokenException {
		...
		try {
			...
			throw new TokenException("SQLGrammar Exception insertTokenToBank-StringTokenDAO");
		} catch (ConstraintViolationException e) {
			LOGGER.error("ConstraintViolation Exception insertTokenToBank-StringTokenDAO", e);
			throw new TokenException("ConstraintViolation Exception insertTokenToBank-StringTokenDAO");
		} catch (HibernateException e) {
			LOGGER.error("Hibernate Exception insertTokenToBank-StringTokenDAO", e);
			throw new TokenException("Hibernat Exception insertTokenToBank-StringTokenDAO");
		} finally {
			session.flush();
			session.clear();
